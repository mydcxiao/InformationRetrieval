...
# specify model path's full pathname
mp = "/Users/xiaoyuhang/Desktop/HW4/DocQA/models/llama-2-7b.Q4_0.gguf"
...
llm = LlamaCpp(model_path=mp)
# embeddings = LlamaCppEmbeddings(model_path="models/llama-7b.ggmlv3.q4_0.bin")
embeddings = LlamaCppEmbeddings(model_path=mp)
